...
<body>
    <div class="sidebar">
        <div class="sidebar-top">
            ...
            <span class="brand"> SMK ALUSI</span>
        </div>
        <div class="sidebar-center">
            <ul class="list">
                ...
                <li class="list-item">
                <i class="list-item-icon fas fa-user-check"></i>
                <span class="list-item-text">Absensi</span>
            </li>
            <li class="list-item">
                <a href="data_anggota.php">
                <i class="list-item-icon fas fa-users"></i>
                <span class="list-item-text">Data Anggota</span>
                </a>
            </li>
                <!-- <li class="list-item"> 
